...
# Precompute the band-independent kinetic phase once per G vector.
...
do
  label=nvhpc_cufft_1rank_02_STEP104_EXKIN_PHASE_ONCE_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP104 KINETIC-PHASE PERFORMANCE SUMMARY"
