...
# Test only device-local COEF-to-COEF0 seed initialization.
# Use 01 first; after it passes without a clear regression, use 02-03.
...
do
  label=nvhpc_cufft_1rank_02_STEP82_COEF0_D2D_SEED_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP82 PERFORMANCE SUMMARY"
