...
# Reuse the kinetic/current WFAC pass for A-vector energy accumulation.
...
do
  label=nvhpc_cufft_1rank_02_STEP112_KINETIC_EED_FUSED_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP112 KINETIC/EED FUSION PERFORMANCE SUMMARY"
