...
# Build and run the single approved FRPRMN host-preparation diagnostic.
# The diagnostic is compile-time OFF unless this helper explicitly enables it.
