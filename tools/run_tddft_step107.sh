...
# Batch the nonpartitioned SEPPOTF s/p reductions over atoms and local bands.
...
do
  label=nvhpc_cufft_1rank_02_STEP107_SEPPOTF_BATCH_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP107 SEPPOTF BATCH PERFORMANCE SUMMARY"
