...
# Enable the Step 107 batched SEPPOTF path for signed NUMTY atom counts.
...
do
  label=nvhpc_cufft_1rank_02_STEP110_SEPPOTF_SIGNED_NUMTY_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP110 SIGNED-NUMTY SEPPOTF PERFORMANCE SUMMARY"
