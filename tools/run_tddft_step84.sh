...
# Test removal of the redundant NONLOC kinetic-factor staging pass.
...
do
  label=nvhpc_cufft_1rank_02_STEP84_NONLOC_KINETIC_FUSE_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP84 PERFORMANCE SUMMARY"
