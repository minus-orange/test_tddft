...
# Re-measure broad FRPRMN envelopes on the accepted Step 80 source.
...
echo
echo "FPSEID21 STEP81 CURRENT FRPRMN SUMMARY"
echo "revision=$(git rev-parse HEAD)"
echo "source_baseline=59686f0"
echo "label=$LABEL"
echo "diagnostic=ON check=PASS compare=PASS"
echo "official_step80_median_sec=67.4207620621"
