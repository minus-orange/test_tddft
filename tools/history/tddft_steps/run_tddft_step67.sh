...
# Test only the VPJ kernel vector-length 128 hypothesis with diagnostics off.
# Use 01 first; after it passes, use 02-03 for the remaining runs.
...
do
  label=nvhpc_cufft_1rank_02_STEP67_VPJ_VL128_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP67 PERFORMANCE SUMMARY"
