...
# Test only the VPJ kernel vector-length 64 hypothesis with diagnostics off.
...
do
  label=nvhpc_cufft_1rank_02_STEP68_VPJ_VL64_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP68 PERFORMANCE SUMMARY"
