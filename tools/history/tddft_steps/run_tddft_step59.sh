...
# Measure the accepted Step 57 LOCPOT envelope with existing timers.
# No source algorithm or data-ownership change is made.

SCRIPT_DIR=$(CDPATH= cd -- "$(dirname -- "$0")" && pwd)
ROOT_DIR=$(CDPATH= cd -- "$SCRIPT_DIR/../../.." && pwd)
RUN_DIR=${RUN_DIR:-"$ROOT_DIR/run/Si111-H_nvhpc"}
LABEL=${LABEL:-nvhpc_cufft_1rank_02_STEP59_LOCPOT_TIMERS_01}
...
echo
echo "FPSEID21 STEP59 CURRENT LOCPOT SUMMARY"
...
echo "Current Step 57 source; diagnostic wall is not a baseline."
