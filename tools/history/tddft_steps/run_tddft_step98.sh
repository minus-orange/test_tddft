...
# Test one enclosing-data-region OpenACC G-space EWALD implementation.
...
do
  label=nvhpc_cufft_1rank_02_STEP98_EWALD_G_ACC_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP98 EWALD G-SPACE OPENACC PERFORMANCE SUMMARY"
