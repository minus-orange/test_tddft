...
# Test only reuse of band-independent YLM preparation within each k-point.
...
do
  label=nvhpc_cufft_1rank_02_STEP74_YLM_REUSE_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP74 PERFORMANCE SUMMARY"
