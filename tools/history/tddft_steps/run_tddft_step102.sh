...
# Precompute the band-independent S2 local phase once per grid point.
...
do
  label=nvhpc_cufft_1rank_02_STEP102_S2_PHASE_ONCE_$run_no
...
do
  ...
  echo
  echo "FPSEID21 STEP102 S2 LOCAL-PHASE PERFORMANCE SUMMARY"
