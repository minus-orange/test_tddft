...
c *** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRX, VWORK,
...
c *** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRX, VWORK,
     &              plancfp,plancbp               )
C
c *** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRY, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c *** for Kokubo ASL FFT
...
c *** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRY, VWORK,
     &              plancfp,plancbp           )
C
c *** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRZ, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c *** for Kokubo ASL FFT
...
c *** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRZ, VWORK,
     &              plancfp,plancbp             )
C
c *** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRXX, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c *** for Kokubo ASL FFT
...
c *** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRXX, VWORK,
     &              plancfp,plancbp            )
C
c *** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRYY, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c *** for Kokubo ASL FFT
...
c *** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRYY, VWORK,
     &              plancfp,plancbp           )
C
c **** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRZZ, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c **** for Kokubo ASL FFT
...
c **** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRZZ, VWORK,
     &              plancfp,plancbp         )
C
c *** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRXY, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c *** for Kokubo ASL FFT
...
c *** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRXY, VWORK,
     &              plancfp,plancbp        )
C
c **** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRYZ, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c **** for Kokubo ASL FFT
...
c **** for Kokubo fftw ASL compatible
        CALL FFT3BX_fftwASL( NRX, NRY, NRZ, NXYZ, DRYZ, VWORK,
     &              plancfp,plancbp          )
C
c **** for Sugino FFT
c        CALL FFT3BX( NRX, NRY, NRZ, NXYZ, DRZX, VWORK,
c     &              WSAVEX, WSAVEY, WSAVEZ, IFACX, IFACY, IFACZ,
c     &              LX1, LX2, LY1, LY2, LZ1, LZ2                 )
c **** for Kokubo ASL FFT
...
C
     ...
     & RHO,RHOG,I2G,
c *** for Sugino FFT
c     & WSAVEX,WSAVEY,WSAVEZ,IFACX,IFACY,IFACZ,LX1,LX2,LY1,LY2,
c     & LZ1,LZ2,EXC,VCSR,DRX,DRY,DRZ,DRXX,DRYY,DRZZ,
c *** for Kokubo ASL FFT
c     & WSAVE_XYZ,IFAC_XYZ,EXC,VCSR,DRX,DRY,DRZ,DRXX,DRYY,DRZZ,
c *** for Kokubo ASL FFT
     & plancfp,plancbp,EXC,VCSR,DRX,DRY,DRZ,DRXX,DRYY,DRZZ,
