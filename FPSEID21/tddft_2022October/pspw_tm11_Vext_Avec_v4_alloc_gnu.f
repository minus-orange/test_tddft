...
c      READ(IWT2)(RAD(K),K=1,MESH)
      READ(IWT,'(5D23.16)') (RAD(K),K=1,MESH)
      READ(IWT2,'(5D23.16)')(RAD(K),K=1,MESH)
      endif
...
c        READ(IWT) (PHIL(K,J),K=1,MESH)
        READ(IWT,'(5D23.16)') (PHIL(K,J),K=1,MESH)
        endif
...
c        READ(IWT2) (PSPOT2(K,J+NVST),K=1,MESH)
        READ(IWT2,'(5D23.16)') (PSPOT2(K,J+NVST),K=1,MESH)
        endif
