...
C
      ...
      ELSEIF(ASAVE(L)(1:2).EQ.'WF') THEN
         ...
         ELSEIF(BSAVE(L)(1:3).eq.'FFT') then
            IOPT(4,1)=2
            write(6,*)' READ PREVIOUS WAVEFUNCTION in real space'
         ELSE
            IOPT(4,1)=1
            WRITE(6,*) ' READ PREVIOUS WAVEFUNCTION FROM FILE22 '
         ENDIF
      ELSEIF(ASAVE(L)(1:2).EQ.'SD') THEN
            I0 = INDEX(BSAVE(L),'(') + 1
            I9 = INDEX(BSAVE(L),')') - 1
            I1 = INDEX(BSAVE(L),',')
            ...
            WRITE(6,*) ' #SD  STEP IS ',ITC7,ITC1,ITCMAX
...
C*************************************************************
     ...
     &        , CTAU(3,NTAUQ), MXOFL(NTYQ)
      ...
      PARAMETER (IRLATQ=120,NARF=IRLATQ)
