...
!$omp end parallel
  203 CONTINUE
     ...
     &          WA1(*),WA2(*)
      ...
      DO 203 K=1,L1
!$omp parallel default(shared)
!$omp do private(IJ,TR2,CR2,TI2,CI2,CR3,CI3,
...
!$omp end parallel
  203 CONTINUE
     ...
     &                WA1(*)     ,WA2(*)     ,WA3(*)
      ...
      DO 203 K=1,L1
!$omp parallel default(shared)
!$omp do private(ij,TI1,TI2,TI3,TR4,TR1,TR2,TI4,TR3,
...
!$omp end parallel
  203 CONTINUE
     ...
     1-.809016994374947D0,.587785252292473D0/
      ...
      DO 203 K=1,L1
!$omp parallel default(shared)
!$omp do private(ij,TI5,TI2,TI4,TI3,TR5,TR2,TR4,TR3,
...
!$omp end parallel
  203 CONTINUE
     ...
     1          WA1(*)     ,WA2(*)     ,WA3(*)
      ...
      DO 203 K=1,L1
!$omp parallel default(shared)
!$omp do private(ij,TI1,TI2,TI3,TR4,TR1,
...
!$omp end parallel
  203 CONTINUE
     ...
     1-.809016994374947D0,-.587785252292473D0/
      ...
      DO 203 K=1,L1
!$omp parallel default(shared)
!$omp do private(ij,TI5,TI2,TI4,TI3,TR5,TR2,
