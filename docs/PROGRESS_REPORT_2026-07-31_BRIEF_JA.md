...
| プラットフォーム | 実行構成 | 実行時間 |
|---|---|---:|
| NVIDIA A100 | 1 GPU / 1 MPI | 63.214秒 |
| NVIDIA H100 | 1 GPU / 1 MPI | 34.109秒 |
| Intel Xeon 6980P | 256コア、32 MPI x 8 OpenMP | 16.539秒 |

A100ではGPU化初期の146.540秒から63.214秒へ短縮し、約2.3倍高速化した。
