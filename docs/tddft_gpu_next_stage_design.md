# FPSEID21 TDDFT GPU Residency Design v5
...
- [DECISION] This file is the final v5 design. No v6 is planned; subsequent corrections retain the v5 title and are identified by the Git commit that contains this exact file content.
